...
function get_media_icons($posId){
	?>
    <div class="media-icons">
    <?php
	if(get_post_meta($posId,'residential',true) == 'true'){
	?>
    <img src="<?php bloginfo('url');?>/wp-content/themes/Silverbullet/images/icons/res.png" class="sm-media-icon" title="Residential" alt="Residential"/>
    <?php
	}
	
	if(get_post_meta($posId,'commercial',true) == 'true'){
	?>
    <img src="<?php bloginfo('url');?>/wp-content/themes/Silverbullet/images/icons/com.png" class="sm-media-icon" title="Cooling Towers" alt="Cooling Towers"/>
    <?php
	}
	
	if(get_post_meta($posId,'agricultural',true) == 'true'){
	?>
    <img src="<?php bloginfo('url');?>/wp-content/themes/Silverbullet/images/icons/ag.png" class="sm-media-icon" title="Agriculture" alt="Agriculture"/>
    <?php
	}
	
	if(get_post_meta($posId,'video',true) == 'true'){
	?>
    <img src="<?php bloginfo('url');?>/wp-content/themes/Silverbullet/images/icons/video.png" class="sm-media-icon" title="Video" alt="Video"/>
    <?php
	}
	
	if(get_post_meta($posId,'news',true) == 'true'){
	?>
    <img src="<?php bloginfo('url');?>/wp-content/themes/Silverbullet/images/icons/news.png" class="sm-media-icon" title="News" alt="News"/>
    <?php
	}
	?>
    </div>
