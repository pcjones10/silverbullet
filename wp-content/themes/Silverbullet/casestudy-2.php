	...
	<li><a href="<?php echo home_url('/memberships'); ?>">Memberships</a></li>
          ...
          <div class="clear"></div>
            <div class="innerbox"> 
                ...
                <div class="banner_left_inner casestudy"><img src="<?php bloginfo('template_url'); ?>/images/norad.jpg" alt="" /></div>
                <div class="banner_right_inner">
                <h1 style="padding-top:50px;">NORAD Cheyenne Mountain Air Force Station - 4.0.1</h1>
                <p></p>
                </div>
