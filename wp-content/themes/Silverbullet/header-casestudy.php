...
if ($post->post_parent == 7 || is_page('7') || $post->post_parent == 437 || is_page('437') ) {
                  ...
                  <div class="secondary">
                       ...
                       <div class="secondarymenu">
						...
						if (is_page('7')) {
							...
							wp_list_pages('title_li=&child_of=759&sort_column=menu_order&sort_order=desc&exclude=429,963');

						} else if ($post->post_parent == 7) {

							wp_list_pages('title_li=&child_of=759&sort_column=menu_order&sort_order=desc&exclude=429,963');

						} else if ($post->post_parent == 437 || is_page('437')) {

							wp_list_pages('title_li=&child_of=759&sort_column=menu_order&sort_order=desc&exclude=35,62,60');
						...
						wp_list_pages('title_li=&child_of=759&sort_column=menu_order&sort_order=desc');	

						}

						?>

                           <li><strong style="padding: 3px 8px;">Case Studies</strong></li>           
